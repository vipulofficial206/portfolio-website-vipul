...
const MIN_SPEED = 50;
const SPEED_DECREMENT = 10; // Speed increases (interval decreases) by this much every 50 points
    ...
    setSnake((prev) => {
      ...
      if (newHead[0] === food[0] && newHead[1] === food[1]) {
        setScore(s => {
          ...
          // Increase speed for every 50 points
          if (newScore % 50 === 0) {
            setSpeed(currentSpeed => Math.max(MIN_SPEED, currentSpeed - SPEED_DECREMENT));
          }
